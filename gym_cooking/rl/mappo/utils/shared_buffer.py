...
from rl.mappo.utils.utils import get_shape_from_act_space, get_shape_from_obs_space
...
class SharedReplayBuffer(object):
    ...
    def __init__(self, num_agents, obs_space, cent_obs_space, act_space, args):
        ...
        self._use_proper_time_limits = False #args['use_proper_time_limits']
    ...
    def feed_forward_generator(self, advantages, num_mini_batch=None, mini_batch_size=None):
        ...
        if mini_batch_size is None:
            assert batch_size >= num_mini_batch, (
                ...
                "".format(n_rollout_threads, episode_length, num_agents, n_rollout_threads * episode_length * num_agents, num_mini_batch))
